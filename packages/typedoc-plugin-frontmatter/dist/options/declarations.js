 ...
 */
export const frontmatterGlobals = {
 ...
 */
export const readmeFrontmatter = {
 ...
 */
export const frontmatterCommentTags = {
    help: 'Specify which comment block tags should be added to frontmatter.',
    type: ParameterType.Array,
};
export const preserveFrontmatterCommentTags = {
